...
public class SlidingDialog extends Dialog {
	 ...
	 * @return
	 */
	public SlidingDialog setPositiveButton(int resid, OnClickListener l) {
		mPositiveListener = l;
	 ...
	 * @return
	 */
	public SlidingDialog setPositiveButton(CharSequence text, OnClickListener l) {
		mPositiveListener = l;
		mBtnPositive.setVisibility(View.VISIBLE);
		mDivider.setVisibility(View.VISIBLE);
	 ...
	 * @return
	 */
	public SlidingDialog setNegativeButton(int resid, OnClickListener l) {
		mNegativeListener = l;
	 ...
	 * @return
	 */
	public SlidingDialog setNegativeButton(CharSequence text, OnClickListener l) {
		mNegativeListener = l;
		mBtnNegative.setVisibility(View.VISIBLE);
		mDivider.setVisibility(View.VISIBLE);
